...
public class Nokia {
    ...
    public static void subMenu2_7() {
        System.out.println("1.Chat Features \n2. Notifications \n3.Spam protection \n4.Change Font." );
        System.out.println("Enter options or 99 to  mainMenu");
        int option = input.nextInt();
        if (option>0 && option<6 || option == 99){
            switch (option){
                case 99:
                    menu2();
                case 1 :
                    System.out.println("""
                            1.Enable chat features  : Enabled
                            2. Send read receipts : Enabled
                            3.Automatically resend a text(sms/mms) : Disabled
                            """);
                    System.out.println("You cant change any feature");
                    System.out.println("Returning to previous menu");
                    subMenu2_7();
                case 2 :
                    ...
                    subMenu2_7();
                case 3 :
                    System.out.println("Spam protection : Enabled");
                    System.out.println("Returning to previous menu");
                    subMenu2_7();
                case 4 :
                    System.out.println("No downloaded Font");
                    System.out.println("Returning to previous menu");
                    subMenu2_7();
